...
📖 نظرة عامة
فاست كوم نظام ERP/تشغيلي متكامل لمكاتب نقل الحاويات اللي بتشتغل على الموانئ المصرية.
النظام بيدير الدورة الكاملة من طلب العميل لحد تحصيل الفاتورة، مع تتبع دقيق
للتكلفة والإيراد وصافي الربح لكل عملية ولكل عميل.
...
│   │   ├── Auth/                # TokenService (JWT + جلب الصلاحيات)
│   │   └── Controllers/
...
<div align="center">
فاست كوم · نظام إدارة مكتب نقل الحاويات والموانئ
